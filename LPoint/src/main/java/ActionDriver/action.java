...
public class action extends BaseClass {
	...
	public static void waitForElementVisibility(WebDriver driver, WebElement loader, int timeOut) {
	    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
	    wait.until(ExpectedConditions.visibilityOf(loader)); // wait for loader to appear
	}
	
	public static void switchToFrameAndClick(WebDriver driver, WebElement ele, WebElement Iframe_btn) {
		driver.switchTo().frame(ele);
		Actions builder = new Actions(driver);
		waitForElementVisibility(driver, Iframe_btn, 50);
		builder.moveToElement(Iframe_btn).click().build().perform();
		//driver.switchTo().defaultContent();
    }
	
	public static void switchOutToFrame(WebDriver driver) {
		driver.switchTo().defaultContent();
    }
	
	public static void waitForElementInVisibility(WebDriver driver, WebElement loader, int timeOut) {
	    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
	...
	public static String getText_Name(WebDriver driver, WebElement element) {
	...
	public static void selectOptnFromDropDown(WebDriver driver, WebElement ele, String text) {
		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	public boolean mouseHoverByJavaScript(WebElement ele) {
	   ...
	   public void scrollUsingJS(WebElement element) {
	        try {
	            ...
	            Assert.assertTrue(false, "Unable to scroll into view: " + e);
	        }
	    }
	...
	public static boolean JSClick(WebDriver driver, WebElement ele) {
		boolean flag = false;
		try {
			waitForElementVisibility(driver, ele, 40);
	...
	public static boolean draggable(WebDriver driver,WebElement source, int x, int d) {
		boolean flag = false;
		try {
			new Actions(driver).dragAndDropBy(source, x, d).build().perform();
			Thread.sleep(5000);
			flag = true;
			return true;
	...
	public static void fluentWaitForElementVisibility(WebDriver driver,WebElement element) {
	    Wait<WebDriver> wait = null;
	    try {
	        wait = new FluentWait<WebDriver>((WebDriver) driver)
